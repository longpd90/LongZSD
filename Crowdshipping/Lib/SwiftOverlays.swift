...
extension UIViewController {
    ...
    func showWaitOverlayWithText(text: String) -> UIView  {
        return SwiftOverlays.showCenteredWaitOverlayWithText(self.view, text: text)
    }
    
    func showTextOverlay(text: String) -> UIView  {
        return SwiftOverlays.showTextOverlay(self.view, text: text)
    }
    
    func showImageAndTextOverlay(image: UIImage, text: String) -> UIView  {
    ...
    func removeAllOverlays() -> Void  {
        return SwiftOverlays.removeAllOverlaysFromView(self.view)
    }
}
...
class SwiftOverlays: NSObject
{
    ...
    class func showCenteredWaitOverlayWithText(parentView: UIView, text: String) -> UIView  {
    ...
    class func showImageAndTextOverlay(parentView: UIView, image: UIImage, text: String) -> UIView  {
        let imageView = UIImageView(image: image)
        
        return showGenericOverlay(parentView, text: text, accessoryView: imageView)
    }

    class func showGenericOverlay(parentView: UIView, text: String, accessoryView: UIView) -> UIView {
    ...
    class func showTextOverlay(parentView: UIView, text: String) -> UIView  {
        let label = labelForText(text)
    ...
    private class func labelForText(text: String) -> UILabel {
